...
function initDynamicContent() {
  ...
  devDynamicContent.Feed_300x250[0].frame1 = "f1.png";
  devDynamicContent.Feed_300x250[0].frame2 = "f2.png";
  devDynamicContent.Feed_300x250[0].frame3 = "f3.png";
  devDynamicContent.Feed_300x250[0].frame4 = "f4.png";
  devDynamicContent.Feed_300x250[0].frame5 = "f5.png";
  devDynamicContent.Feed_300x250[0].frame5_disclaimer = "disclaimer.png";
  devDynamicContent.Feed_300x250[0].frame5_legals = "legals.png";
  devDynamicContent.Feed_300x250[0].arrow = "arrow.png";
  devDynamicContent.Feed_300x250[0].DEFAULT = true;

  Enabler.setDevDynamicContent(devDynamicContent);

  // Loop through assets to generate preload manifest list
  for (var key in dynamicContent.Feed_300x250[0].Content_path){
    var assetsObj = {};
    assetsObj.src = dynamicContent.Feed_300x250[0].Content_path[key]['Url'];
    assetsObj.id = key;
...
function prepAssets(){
  ...
  document.getElementById('bkg').appendChild(loadedImages[dynamicContent.Feed_300x250[0].background_image]);
  // Logo
  document.getElementById("content").innerHTML += "<div id='logo'></div>";
  document.getElementById('logo').appendChild(loadedImages[dynamicContent.Feed_300x250[0].logo_image]);
  // F1
  document.getElementById("content").innerHTML += "<div id='F1'></div>";
  document.getElementById('F1').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame1]);
  // F2
  document.getElementById("content").innerHTML += "<div id='F2'></div>";
  document.getElementById('F2').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame2]);
  // F3
  document.getElementById("content").innerHTML += "<div id='F3'></div>";
  document.getElementById('F3').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame3]);
  // F4
  document.getElementById("content").innerHTML += "<div id='F4'></div>";
  document.getElementById('F4').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame4]);
  // F5
  document.getElementById("content").innerHTML += "<div id='F5'></div>";
  document.getElementById('F5').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame5]);
  // CTA button
  document.getElementById("content").innerHTML += "<div id='button'></div>";
  document.getElementById('button').appendChild(loadedImages[dynamicContent.Feed_300x250[0].cta]);
  // Arrow
  document.getElementById("content").innerHTML += "<div id='arrow'></div>";
  document.getElementById('arrow').appendChild(loadedImages[dynamicContent.Feed_300x250[0].arrow]);
  // Legal copy (Frame 5)
  document.getElementById("content").innerHTML += "<div id='legals'></div>";
  document.getElementById('legals').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame5_legals]);
  // Disclaimer copy (Frame 5)
  document.getElementById("content").innerHTML += "<div id='disclaimer'></div>";
  document.getElementById('disclaimer').appendChild(loadedImages[dynamicContent.Feed_300x250[0].frame5_disclaimer]);
}
